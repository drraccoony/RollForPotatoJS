...
function renderTimer(h, m, s) {
    ...
    if (minutes >= 10) { document.getElementById("minutes").innerHTML = m }
    else { document.getElementById("minutes").innerHTML = '0' + m }

    if (seconds >= 10) { document.getElementById("seconds").innerHTML = s }
    else { document.getElementById("seconds").innerHTML = '0' + s }
}
...
function updateTimerValues() {
    if (document.getElementById("newHour").value == '' || document.getElementById("newMin").value == '' || document.getElementById("newSec").value == '')
    {
